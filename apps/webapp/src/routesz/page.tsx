    ...
    <div className="min-h-screen flex flex-col">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 md:pr-10">
                A research prototype exploring the implementation of secure, transparent electoral processes using
              ...
              <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 md:p-10">
                ...
                <div className="space-y-6">
                  <div className="bg-gray-50 rounded-lg p-4">
                    <div className="text-sm text-gray-500 mb-1">2024 Presidential Election</div>
      ...
      <section id="benefits" className="py-20 px-4 bg-white">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Research Findings: Blockchain Electoral Systems</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our research demonstrates how blockchain technology can address key challenges in traditional electoral
              systems through smart contract implementation.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-600">
                  Once a vote is recorded on the blockchain, it cannot be altered or deleted, ensuring the integrity of
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-600">
                  All transactions are publicly verifiable while maintaining voter privacy, allowing anyone to audit the
                  election results.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-600">
                  Cryptographic techniques ensure that votes cannot be tampered with, preventing fraud and manipulation.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-600">
                  Instant vote counting and result tabulation, eliminating delays and reducing the cost of traditional
                  counting methods.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="pt-6">
                ...
                <h3 className="text-xl font-bold mb-2">Increased Participation</h3>
                <p className="text-gray-600">
                  Remote voting capabilities make participation easier, potentially increasing voter turnout and
                  engagement.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-600">
                  Reduces the need for physical infrastructure, paper ballots, and manual counting, lowering the overall
                  cost of elections.
                </p>
              </CardContent>
            </Card>
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-blue-50 to-indigo-100">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              BlockVote provides a comprehensive suite of tools for managing secure, transparent elections.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span>Create and configure elections with customizable parameters</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                  <span>Generate unique registration links for candidates and voters</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                  <span>Set election timelines with automatic start and end dates</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                  <span>Monitor registration and voting statistics in real-time</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                  <span>Secure identity verification using National Identity Numbers</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                  <span>Election-specific registration links for candidates and voters</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                  <span>Automated eligibility verification based on predefined criteria</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                  <span>Blockchain-backed vote recording with immutable audit trail</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                  <span>One-vote-per-position enforcement to prevent double voting</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                  <span>End-to-end encryption for voter privacy protection</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                  <span>Vote confirmation receipts with blockchain transaction IDs</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                  <span>Detailed analytics on voter demographics and participation</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                ...
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                  <span>Public results verification through blockchain explorer</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      <section id="team" className="py-20 px-4 bg-white">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Electrical Electronics Engineering students collaborating on this blockchain electoral system research
              project.
            </p>
          </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-blue-600 to-indigo-700 text-white">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Explore the Research Prototype</h2>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link href="/documentation">
              <Button variant="outline" size="lg" className="h-12 px-6 border-white text-white hover:bg-white/10">
