...
export default function ElectionCreation() {
	...
	const handleStateChange = (state: string, checked: boolean) => {
		setFormData((prev) => ({
			...prev,
			eligibleStates: checked
				? [...prev.eligibleStates, state]
				: prev.eligibleStates.filter((s) => s !== state),
		}));
	};
					...
					<div className="lg:col-span-2">
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Configure a new election with all necessary parameters
								</CardDescription>
							</CardHeader>
							<CardContent>
										...
										{elections.map((election) => (
											<div key={election.id} className="border rounded-lg p-3">
												...
												<p className="text-xs text-green-600">
													{election.eligibleStates.length} states
												</p>
												<div className="mt-2">
